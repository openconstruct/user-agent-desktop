...
{
  "addons": {
    "umbra": "https://umbra-deployments.s3.amazonaws.com/umbra-extension/8.5.4.5bf5c45f/umbra-firefox-v8.5.4.zip",
    "umbra-search": "https://github.com/umbra/umbra-search-extension/releases/download/v0.1.12/umbra_search-0.1.12.zip"
  },
  "firefox": "82.0.2",
  "app": "2020.10.1"
}
...
```sh
git clone https://github.com/umbra/user-agent-desktop.git
cd user-agent-desktop
npm ci # Fern.js dependencies
./fern.js use # Pull the correct Firefox and Umbra extension sources
./fern.js import-patches # Apply patches to Firefox
cd mozilla-release
./mach bootstrap
MOZCONFIG=/path/to/user-agent-desktop/brands/Umbra/mozconfig ./mach build # start build
...
5.  `./mach python build/pgo/profileserver.py --binary /path/to/Umbra-bin`
