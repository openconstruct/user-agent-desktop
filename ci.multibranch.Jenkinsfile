...
stage('Build Linux') {
    node('browser-builder') {
        ...
        sh """
            mkdir -p pkg/linux
            cp mozilla-release/${settings.objDir}/dist/Umbra-${version}.en-US.linux-x86_64.tar.gz pkg/linux/Umbra-${version}.en-US.linux.tar.gz
            cp mozilla-release/${settings.objDir}/dist/Umbra-${version}.de.linux-x86_64.tar.gz pkg/linux/Umbra-${version}.de.linux.tar.gz
            cp mozilla-release/${settings.objDir}/dist/Umbra-${version}.fr.linux-x86_64.tar.gz pkg/linux/Umbra-${version}.fr.linux.tar.gz
        """
...
stage('Sign Windows') {
    def packages = [
        ["mozilla-release/obj-aarch64-pc-windows-msvc/dist/Umbra-${version}.en-US.win64-aarch64.zip", 'pkg/arm-en'],
        ["mozilla-release/obj-aarch64-pc-windows-msvc/dist/Umbra-${version}.de.win64-aarch64.zip", 'pkg/arm-de'],
        ["mozilla-release/obj-aarch64-pc-windows-msvc/dist/Umbra-${version}.fr.win64-aarch64.zip", 'pkg/arm-fr'],
        ["mozilla-release/obj-x86_64-pc-windows-msvc/dist/Umbra-${version}.en-US.win64.zip", 'pkg/x86-en'],
        ["mozilla-release/obj-x86_64-pc-windows-msvc/dist/Umbra-${version}.de.win64.zip", 'pkg/x86-de'],
        ["mozilla-release/obj-x86_64-pc-windows-msvc/dist/Umbra-${version}.fr.win64.zip", 'pkg/x86-fr'],
    ]

    node('browser-builder') {
        docker.image('ua-sign-windows').inside() {
            for (pkg in packages) {
                sh "rm -rf ${pkg[1]}/Umbra"
                try {
                    sh "unzip ${pkg[0]} -d ${pkg[1]}"

                    signWindowsBinaries("${pkg[1]}/Umbra")

                    String archiveName = pkg[0].split('/').last()

                    sh "cd ${pkg[1]} && zip -r ${archiveName} Umbra"
                } finally {
                    sh "rm -rf ${pkg[1]}/Umbra"
                }
            }
...
stage('Repackage Windows installers') {
    node('browser-builder') {
        def installersX86 = [
            ["pkg/x86-en/Umbra-${version}.en-US.win64.zip", "pkg/Umbra-${version}.en-US.win64.installer.exe", 'en-US'],
            ["pkg/x86-de/Umbra-${version}.de.win64.zip", "pkg/Umbra-${version}.de.win64.installer.exe", 'de'],
            ["pkg/x86-fr/Umbra-${version}.fr.win64.zip", "pkg/Umbra-${version}.fr.win64.installer.exe", 'fr'],
        ]
        ...
        def installersARM = [
            ["pkg/arm-en/Umbra-${version}.en-US.win64-aarch64.zip", "pkg/Umbra-${version}.en-US.win64-aarch64.installer.exe", 'en-US'],
            ["pkg/arm-de/Umbra-${version}.de.win64-aarch64.zip", "pkg/Umbra-${version}.de.win64-aarch64.installer.exe", 'de'],
            ["pkg/arm-fr/Umbra-${version}.fr.win64-aarch64.zip", "pkg/Umbra-${version}.fr.win64-aarch64.installer.exe", 'fr'],
        ]
        ...
        def stubInstallersX86 = [
            ["pkg/x86-en/Umbra-${version}.en-US.win64.zip", "pkg/Umbra-${version}.en-US.win64.installer-stub.exe", 'en-US'],
            ["pkg/x86-de/Umbra-${version}.de.win64.zip", "pkg/Umbra-${version}.de.win64.installer-stub.exe", 'de'],
            ["pkg/x86-fr/Umbra-${version}.fr.win64.zip", "pkg/Umbra-${version}.fr.win64.installer-stub.exe", 'fr'],
        ]
        ...
        def stubInstallersARM = [
            ["pkg/arm-en/Umbra-${version}.en-US.win64-aarch64.zip", "pkg/Umbra-${version}.en-US.win64-aarch64.installer-stub.exe", 'en-US'],
            ["pkg/arm-de/Umbra-${version}.de.win64-aarch64.zip", "pkg/Umbra-${version}.de.win64-aarch64.installer-stub.exe", 'de'],
            ["pkg/arm-fr/Umbra-${version}.fr.win64-aarch64.zip", "pkg/Umbra-${version}.fr.win64-aarch64.installer-stub.exe", 'fr'],
        ]
...
stage('Unify Mac DMG') {
    node('browser-builder') {
        ...
        def dmgs = [
            ["mozilla-release/${armObjDir}/dist/Umbra-${version}.en-US.mac.dmg", "mozilla-release/${x86ObjDir}/dist/Umbra-${version}.en-US.mac.dmg", "pkg/Umbra-${version}.en-US.dmg"],
            ["mozilla-release/${armObjDir}/dist/Umbra-${version}.de.mac.dmg", "mozilla-release/${x86ObjDir}/dist/Umbra-${version}.de.mac.dmg", "pkg/Umbra-${version}.de.dmg"],
            ["mozilla-release/${armObjDir}/dist/Umbra-${version}.fr.mac.dmg", "mozilla-release/${x86ObjDir}/dist/Umbra-${version}.fr.mac.dmg", "pkg/Umbra-${version}.fr.dmg"],
        ]
...
stage('Sign Mac') {
    node('gideon') {
        ...
        def packages = [
            ["pkg/Umbra-${version}.en-US.dmg", 'pkg/mac-en'],
            ["pkg/Umbra-${version}.de.dmg", 'pkg/mac-de'],
            ["pkg/Umbra-${version}.fr.dmg", 'pkg/mac-fr'],
        ]

        withEnv([
            'APP_NAME=Umbra',
            'PKG_NAME=Umbra Private Browser',
...
stage('Repackage Mac') {
    node('browser-builder') {
        ...
        def dmgs = [
            ["pkg/mac-en/Umbra-${version}.en-US.tar.gz", "pkg/Umbra-${version}.en-US.mac.dmg"],
            ["pkg/mac-de/Umbra-${version}.de.tar.gz", "pkg/Umbra-${version}.de.mac.dmg"],
            ["pkg/mac-fr/Umbra-${version}.fr.tar.gz", "pkg/Umbra-${version}.fr.mac.dmg"],
        ]
...
stage('Repackage MAR') {
    node('browser-builder') {
        ...
        def packages = [
            ['x86_64', "pkg/linux/Umbra-${version}.en-US.linux.tar.gz", "pkg/mars/Umbra-${version}.en-US.linux-x86_64.complete.mar"],
            ['x86_64', "pkg/linux/Umbra-${version}.de.linux.tar.gz", "pkg/mars/Umbra-${version}.de.linux-x86_64.complete.mar"],
            ['x86_64', "pkg/linux/Umbra-${version}.fr.linux.tar.gz", "pkg/mars/Umbra-${version}.fr.linux-x86_64.complete.mar"],
            ['macos-x86_64-aarch64', "pkg/mac-en/Umbra-${version}.en-US.tar.gz", "pkg/mars/Umbra-${version}.en-US.mac.complete.mar"],
            ['macos-x86_64-aarch64', "pkg/mac-de/Umbra-${version}.de.tar.gz", "pkg/mars/Umbra-${version}.de.mac.complete.mar"],
            ['macos-x86_64-aarch64', "pkg/mac-fr/Umbra-${version}.fr.tar.gz", "pkg/mars/Umbra-${version}.fr.mac.complete.mar"],
            ['x86', "pkg/x86-en/Umbra-${version}.en-US.win64.zip", "pkg/mars/Umbra-${version}.en-US.win64.complete.mar"],
            ['x86', "pkg/x86-de/Umbra-${version}.de.win64.zip", "pkg/mars/Umbra-${version}.de.win64.complete.mar"],
            ['x86', "pkg/x86-fr/Umbra-${version}.fr.win64.zip", "pkg/mars/Umbra-${version}.fr.win64.complete.mar"],
            ['aarch64', "pkg/arm-en/Umbra-${version}.en-US.win64-aarch64.zip", "pkg/mars/Umbra-${version}.en-US.win64-aarch64.complete.mar"],
            ['aarch64', "pkg/arm-de/Umbra-${version}.de.win64-aarch64.zip", "pkg/mars/Umbra-${version}.de.win64-aarch64.complete.mar"],
            ['aarch64', "pkg/arm-fr/Umbra-${version}.fr.win64-aarch64.zip", "pkg/mars/Umbra-${version}.fr.win64-aarch64.complete.mar"],
        ]
    ...
    if (shouldRelease) {
        node('browser-builder') {
            docker.image('ua-build-base').inside() {
                def artifacts = [
                    "pkg/Umbra-${version}.en-US.mac.dmg",
                    "pkg/Umbra-${version}.de.mac.dmg",
                    "pkg/Umbra-${version}.fr.mac.dmg",
                    "pkg/linux/Umbra-${version}.en-US.linux.tar.gz",
                    "pkg/linux/Umbra-${version}.de.linux.tar.gz",
                    "pkg/linux/Umbra-${version}.fr.linux.tar.gz",
                    "pkg/Umbra-${version}.en-US.win64.installer.exe",
                    "pkg/Umbra-${version}.de.win64.installer.exe",
                    "pkg/Umbra-${version}.fr.win64.installer.exe",
                    "pkg/Umbra-${version}.en-US.win64-aarch64.installer.exe",
                    "pkg/Umbra-${version}.de.win64-aarch64.installer.exe",
                    "pkg/Umbra-${version}.fr.win64-aarch64.installer.exe",
                    "pkg/Umbra-${version}.en-US.win64.installer-stub.exe",
                    "pkg/Umbra-${version}.de.win64.installer-stub.exe",
                    "pkg/Umbra-${version}.fr.win64.installer-stub.exe",
                    "pkg/Umbra-${version}.en-US.win64-aarch64.installer-stub.exe",
                    "pkg/Umbra-${version}.de.win64-aarch64.installer-stub.exe",
                    "pkg/Umbra-${version}.fr.win64-aarch64.installer-stub.exe",
                    "pkg/mars/Umbra-${version}.en-US.linux-x86_64.complete.mar",
                    "pkg/mars/Umbra-${version}.de.linux-x86_64.complete.mar",
                    "pkg/mars/Umbra-${version}.fr.linux-x86_64.complete.mar",
                    "pkg/mars/Umbra-${version}.en-US.mac.complete.mar",
                    "pkg/mars/Umbra-${version}.de.mac.complete.mar",
                    "pkg/mars/Umbra-${version}.fr.mac.complete.mar",
                    "pkg/mars/Umbra-${version}.en-US.win64.complete.mar",
                    "pkg/mars/Umbra-${version}.de.win64.complete.mar",
                    "pkg/mars/Umbra-${version}.fr.win64.complete.mar",
                    "pkg/mars/Umbra-${version}.en-US.win64-aarch64.complete.mar",
                    "pkg/mars/Umbra-${version}.de.win64-aarch64.complete.mar",
                    "pkg/mars/Umbra-${version}.fr.win64-aarch64.complete.mar",
                ]
                ...
                withCredentials([
                    ...
                    def id = sh(returnStdout: true, script: """
                        curl \
                            ...
                            https://api.github.com/repos/umbra/user-agent-desktop/releases/tags/${params.ReleaseName} \
                        | jq .id
                    """).trim()
                    ...
                    for (String artifactPath in artifacts) {
                        ...
                        sh("""
                            curl \
                                ...
                                "https://uploads.github.com/repos/umbra/user-agent-desktop/releases/$id/assets?name=$artifactName"
                        """)
                    }
                }
            }
...
def withMach(platform, task) {
    ...
    image.inside(
        ...
        withEnv([
            ...
            'ACCEPTED_MAR_CHANNEL_IDS=firefox-umbra-release',
            'MAR_CHANNEL_ID=firefox-umbra-release',
            "MOZ_PKG_FORMAT=${settings.packageFormat}",
        ]) {
            sh "./fern.js config --print --force -l --platform ${settings.targetPlatform} --brand Umbra"
