...
# NSIS branding defines for Umbra builds.
# The official release build branding.nsi is located in other-license/branding/firefox/
# The nightly build branding.nsi is located in browser/installer/windows/nsis/

# BrandFullNameInternal is used for some registry and file system values
# instead of BrandFullName and typically should not be modified.
!define BrandFullNameInternal "Umbra Browser"
!define BrandFullName         "Umbra Browser"
!define CompanyName           "Umbra"
!define URLInfoAbout          "https://www.umbra.com"
!define HelpLink              "https://get.umbrabrowser.com/support/"

!define URLStubDownloadX86 "https://get.umbrabrowser.com/download/win32-installer/${AB_CD}"
!define URLStubDownloadAMD64 "https://get.umbrabrowser.com/download/win64-installer/${AB_CD}"
!define URLStubDownloadAArch64 "https://get.umbrabrowser.com/download/win64-aarch64-installer/${AB_CD}"
!define URLManualDownload "https://get.umbrabrowser.com/download/landing/${AB_CD}"
!define URLSystemRequirements "https://www.umbra.com/private-browser/"
!define Channel "release"

# The installer's certificate name and issuer expected by the stub installer.
# Update these when production signing is finalized.
!define CertNameDownload   "Umbra"
!define CertIssuerDownload "Umbra"
